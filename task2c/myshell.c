...
void tildaCase(cmdLine *line){
    ...
    {
        memset(temp, '\0', 1024); /*fills up temp with the '\0'. You'll see why in 'replacing' */
...
void exclamationMarkCase(cmdNode* head,cmdLine** cmd){/*we use a pointer because we want to change the value of cmd from where this function was called. using cmdLine* is not enough*/
