...
int main(int argc,char **argv){
    ...
    while(shouldquit!=0){/*the main endless loop*/
        ...
        if(shouldquit!=0){/*meaning the user sent us a command he wants to execute*/
        execute(command);
        }
